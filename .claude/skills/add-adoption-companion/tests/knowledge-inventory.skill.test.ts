...
//
// Reads the canonical copy under the pack's add/ tree — the one Step 5b copies
// to container/skills/ — rather than an installed copy, so these run in CI on
// every checkout, installed or not.
//
...
const SKILL_PATH = 'add/container/skills/knowledge-inventory/SKILL.md';

const skill = readFileSync(join(packRoot, SKILL_PATH), 'utf8');

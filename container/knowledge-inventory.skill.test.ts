...
//
// This file is part of the skill's payload: it lives on the `adoption-companion`
// branch beside the SKILL.md it guards, and /add-adoption-companion copies both
// in together (the add-slack idiom — a channel's registration test travels with
// its adapter). It cannot live in trunk, because trunk does not ship the skill
